---
name: twitter-scraper-faq
description: Frequently asked questions about scraping Twitter/X data with fetcher.sh — search, followers, monitoring, and rate limits, answered with exact endpoints.
---
...
### Does `twitter-scraper` cover both "Twitter" and "X" branding?

Yes — this skill and its sibling [`x-scraper`](../../x-scraper/SKILL.md) hit
the exact same host and endpoints; `x-scraper` just leads with "X" wording so
