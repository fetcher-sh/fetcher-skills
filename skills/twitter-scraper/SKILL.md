...
description: >-
  ...
  by country, or search for X accounts by name. Also covers building a tweet
  scraper, Twitter data pipeline, competitor monitoring, hashtag tracking,
  sentiment analysis input, or follower export without the official X API's
  pricing tiers or app-review process.
keywords:
  - twitter
  - x
  - twitter-api
...
Also published as [`x-scraper`](../x-scraper/SKILL.md) — same host, same
